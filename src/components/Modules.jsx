...
export default function Modules() {
  ...
  const [modules] = useState([
    { id: 1, module: "User Experience Design", code: "GL 122", semester: "1", level: "Master 1", coefficient: "3", teacher: "AMRAOUI.A" },
    { id: 2, module: "Management De Projet", code: "GL 112", semester: "2", level: "Licence 1", coefficient: "2", teacher: "ALEZOUNI.L" },
  ]);
            ...
            <tbody>
              {modules.map((item) => (
                <tr key={item.id}>
                  <td>{item.module}</td>
                  <td>{item.code}</td>
                  <td className="center-text">{item.semester}</td>
                  <td>{item.level}</td>
                  <td className="center-text">{item.coefficient}</td>
                  <td>{item.teacher}</td>
                  <td>
