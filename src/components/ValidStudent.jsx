...
export default function ValidStudent() {
  const Exam = [
    {
      name: "BOUCHRIT",
      firstName: "Amine",
      ...
      <div className="wrapper">
        ...
        <div className="filters">
          <div className="filter-group">
            ...
            <button className="filter active">Valid</button>
        ...
        <table>
          ...
          <tbody>
            {Exam.filter(person => person.status === "Valid").map((person, index) => (
              <tr key={index}>
                <td>{person.name}</td>
                ...
                <td>{person.group}</td>
                <td>
                  <span className="status valid">{person.status}</span>
                </td>
