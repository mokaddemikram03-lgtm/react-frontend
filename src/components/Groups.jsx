...
export default function GROUPS() {
  ...
  const [groups] = useState([
    { id: 1, group: "Group A", levels: "Licence 1", NB_Students: "40", status: "actif" },
    { id: 2, group: "Group B", levels: "Master 2", NB_Students: "30", status: "actif" },
  ]);
  ...
  return (
    <div className="page">
      <style>{`
        .page { background: #d9d9d9; padding: 40px; min-height: 100vh; }
        ...
        .status.actif { background:#6ef188ff;color: #000; }
            ...
            <tbody>
              {groups.map((item) => (
                <tr key={item.id}>
                  ...
                  <td><span className="status actif">{item.status}</span></td>
                  <td>
