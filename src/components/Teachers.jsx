...
export default function Teachers() {
  ...
  const [teachers] = useState([
    { id: 1, name: "MEZIENE", first_name: "Mohamed", E_mail: "m.mohamed@univ.dz", speciality: "Base de donnee" ,status:"Here"},
    { id: 2, name: "FEKAR", first_name: "Riyadh", E_mail: "f.riyadh@univ.dz", speciality: "Reseau" , status:"Absent"},
  ]);
  ...
  return (
    <div className="page">
      <style>{`
        ...
        .status.Here { background:#6ef188ff;color: #000; }
        .status.Absent { background:#f85353ff;color: #000; }
