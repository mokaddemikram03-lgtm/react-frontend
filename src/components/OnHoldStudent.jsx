...
export default function OnHoldStudent() {
   const Exam = [
    {
      name: "BOUCHRIT",
      firstName: "Amine",
    ...
    <>
      ...
      <div className="wrapper">
        ...
        <div className="menu-rectangles">
          ...
          <div className="menu-item active"><span className="icon">👨‍🎓</span> Students</div>
        ...
        <div className="filters">
          <div className="filter-group">
            ...
            <button className="filter active">On hold</button>
        ...
        <table>
          ...
          <tbody>
            {Exam.filter(person => person.status === "On hold").map((person, index) => (
              <tr key={index}>
                <td>{person.name}</td>
                ...
                <td>{person.group}</td>
                <td>
                  <span className="status on-hold">{person.status}</span>
                </td>
