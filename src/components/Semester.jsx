  ...
  return (
    <div className="page">
      <style>{`
        ...
        .status.in-progress { background:#5a7de0;color: #000; }
        .status.planned { background:orange;color: #000; }
            ...
            <tbody>
              {years.map((item) => (
                <tr key={item.id}>
                  ...
                  <td>{item.endDate}</td>
                  <td>
                    <span className={item.status === "in progress" ? "status in-progress" : "status planned"}>
                      {item.status}
                    </span>
                  </td>
                  <td>
