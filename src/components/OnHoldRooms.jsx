...
export default function OnHoldRooms() {
   const rooms = [
    {
      room: "ROOM N005",
      ability: 50,
    ...
    <>
      ...
      <div className="wrapper">
        ...
        <div className="menu-rectangles">
          ...
          <div className="menu-item active"><span className="icon">🚪</span> Rooms</div>
        </div>
        ...
        <table>
          ...
          <tbody>
            {rooms.filter(room => room.status === "On hold").map((room, index) => (
              <tr key={index}>
                 <td>{room.room}</td>
                <td>{room.ability}</td>
                <td>{room.type}</td>
                ...
                <td>
                  <span className="status on-hold">{room.status}</span>
                </td>
