...
export default function Levels() {
  ...
  const tabs = [
    ...
    { name: "Levels", icon: () => <div className="level-bars"></div> },
  ...
  return (
    <div className="page">
      <style>{`
        ...
        .logo-box {
          width:48px; height:48px; background:#0f056b;
        ...
        .tab {
          ...
          cursor:pointer; font-weight:500; color:#444;
        }
        ...
        .search-box input {
          ...
          background:#aaaaaa; border-radius:8px; border:none;
        }
        .search-icon { position:absolute; top:50%; left:12px; transform:translateY(-50%); color:gray; }

        .btn-add {
          background:#0f056b; color:white;
          padding:12px 20px; border-radius:8px;
          border:none; display:flex; gap:8px;
        ...
        th {
          text-align:left; padding:12px; font-weight:bold;
          background:white;
        }
